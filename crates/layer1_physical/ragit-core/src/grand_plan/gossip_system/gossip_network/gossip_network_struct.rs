...
impl GossipNetwork {
    ...
    /// Simulates a node gossiping a new event to all its known peers.
    pub fn simulate_gossip_event(&mut self, sender_id: &str, event: crate::grand_plan::introspector_sidechain::sidechain_event::sidechain_event_enum::SidechainEvent) {
