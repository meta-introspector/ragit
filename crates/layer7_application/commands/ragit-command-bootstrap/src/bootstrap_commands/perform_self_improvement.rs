...
pub async fn perform_self_improvement(
    ...
    memory_monitor.verbose(&format!("perform_self_improvement: Retrieved self code ({} bytes).", self_code.len()));
    ...
    memory_monitor.verbose(&format!("perform_self_improvement: Executed self-improvement query. Response length: {}.", improved_code.len()));
