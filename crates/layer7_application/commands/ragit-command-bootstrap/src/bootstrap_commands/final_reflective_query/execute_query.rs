...
pub async fn execute_query(
    ...
    memory_monitor.verbose(&format!("execute_query (final reflective query): Executing query: '{}'", FINAL_REFLECTIVE_QUERY_PROMPT));
    ...
    memory_monitor.verbose(&format!("execute_query (final reflective query): Query response: '{}'", response.get_message()));
