...
pub fn log_start(_verbose: bool, memory_monitor: &mut MemoryMonitor) {
    memory_monitor.verbose("log_start (final_reflective_query): Starting final reflective query.");
    ...
    memory_monitor.verbose("log_start (final_reflective_query): Finished logging start of final reflective query.");
}
