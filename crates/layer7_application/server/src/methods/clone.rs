...
//     repo::check_auth(repo_id, RepoOperation::Clone, api_key, pool)
//         .await
//         .handle_error(500)?
//         .handle_error(404)?;
//     let session_id = repo::get_session_id(repo_id, pool)
//         .await
//         .handle_error(404)?;
//     let archive_list = match session_id {
//         Some(session_id) => archive::get_list(&session_id, pool)
//             .await
//             .handle_error(500)?,
...
//     let bytes = archive::get_archive(&session_id, &archive_id, pool)
//         .await
//         .handle_error(404)?;
...
//     if archive::is_first_archive(&session_id, &archive_id, pool)
//         .await
//         .handle_error(500)?
//     {
//         archive::increment_clone_count(repo_id, pool)
//             .await
//             .handle_error(500)?;
//     }
