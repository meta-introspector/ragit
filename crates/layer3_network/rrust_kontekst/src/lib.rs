...
// Import the procedural macro from the new crate
use rrust_kontekst_proc_macros::mcp_component;

pub mod prelude;

pub use prelude::*;

// --- Functions moved from src/mcp.rs ---
