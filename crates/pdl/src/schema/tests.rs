...
fn schema_validate_test() {
    let samples = vec![
        (
            "{ name: str, age: int }",
            "[]",
            Some("cannot find `object`"),
        ),
        (
            "{ name: str, age: int }",
            "{}",
            Some("missing fields: name, age"),
        ),
        (
            "{ name: str, age: int }",
            "{ \"name\": \"bae\", \"age\": 28 }",
        ...
        (
            "{ name: str, age: int }",
            "This is the result: { \"name\": \"bae\", \"age\": 28 }",
            None,
        ),
        (
            "{ name: str, age: int }",
            " { \"e\": true } { \"name\": \"bae\", \"age\": 28 }",
            Some("more than 1 candidates"),
        ),
        ("bool", "true", None),
        ...
        (
            "[int { min: 4000 }]",
            "[2300]",
            Some("make sure that the value is at least 4000"),
        ),
        (
            "[int { max: 400 }]",
            "[2300]",
            Some("make sure that the value is at most 400"),
        ),
        ...
        (
            "[int] {max : 5}",
            "[1, 2, 3, 4, 5, true]",
            Some("`integer`, not `boolean`"),
        ),
        ("str", "Anything is okay", None),
        (
            "str { max: 10 }",
            "This is not okay",
            Some("at most 10 characters"),
        ),
        (
            "code",
            "There's no code here",
            Some("I cannot find a code block"),
        ),
        (
            "code",
...
```",
        ...
        (
            "[str]",
            "Stop using regex and write your own parser: [\"[]\", \"[]\"]",
            None,
        ),
        (
            "[str]",
        ...
        (
            "[int]",
            "I guess [1, 2, 3] would be good.\n\nAnswer: [1, 2, 3]",
            None,
        ),
        (
            "[int]",
            "I guess [1, 2, 3] would be good. No, come to think about it, I don't think 2 is appropriate for this.\n\nAnswer: [1, 3]",
            Some("more than 1 candidates"),
        ),
        (
            "float",
            "It's either 1.5 or 2",
            Some("more than 1 candidates"),
        ),
        ...
        (
            ...
            Some("I cannot find a task list"),
        ),
        (
            "tasklist",
            "
